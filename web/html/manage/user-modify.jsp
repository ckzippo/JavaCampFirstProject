...
<div id="main" class="wrap">
    ...
    <div class="main">
        <h2>修改用户</h2>
        <div class="manage">
            <form action="modUser" enctype="multipart/form-data" method="post">
                <table class="form">
                    <tr>
                        <td><input type="hidden" name="userid" value="${user.eu_user_id}"></td>
                    </tr>
                    <tr>
                        <td class="field">用户名：</td>
                        <td><input type="text" class="text" name="userName" value="${user.eu_user_name}" readonly="readonly" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <c:choose>
                            <c:when test="${user.eu_sex == 0}">
                                <td><input type="radio" name="sex" value="1" checked="checked"/>男 <input type="radio"
                                                                                                         name="sex"
                                                                                                         value="1"/>女
                                </td>
                            </c:when>
                            <c:when test="${user.eu_sex == 1}">
                                <td><input type="radio" name="sex" value="1"/>男 <input type="radio" name="sex" value="1"
                                                                                       checked="checked"/>女
                                </td>
                            </c:when>
                        </c:choose>
